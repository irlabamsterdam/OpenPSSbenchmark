...
def main(arguments):
    ...
    # We automatically save the predictions of our model for later usage
    with open('../resources/experiment3_outputs/AUTOENCODER/%s_%s/predictions.json' % (arguments.train_dataset,
